...
class KansasLotteryScraper implements BaseScraper
{
    public function canHandle(string $url): bool
    {
        return str_contains($url, 'kslottery.com');
    }

    
    public function getSiteName(): string
    {
        return 'Kansas Lottery';
    }
    ...
    public function extractBasicInfo(Crawler $crawler): array
    {
        ...
        try {
            ...
            Log::error('Failed to extract basic info from Kansas Lottery: ' . $e->getMessage());
        }
    ...
    public function extractOdds(Crawler $crawler): array
    {
        ...
        try {
            ...
            Log::error('Failed to extract odds from Kansas Lottery: ' . $e->getMessage());
        }
    ...
    public function extractImage(Crawler $crawler): ?string
    {
        try {
            ...
            Log::error('Failed to extract image from Kansas Lottery: ' . $e->getMessage());
            return null;
        }
    }
    ...
    public function scrape(Crawler $crawler, string $url): array
    {
        try {
            ...
            Log::error('Kansas Lottery scraping failed: ' . $e->getMessage(), ['url' => $url]);
            return ['error' => 'Failed to scrape Kansas Lottery data', 'url' => $url];
        }
    }
    ...
    public function extractPrizes(Crawler $crawler): array
    {
        ...
        try {
            ...
            Log::error('Failed to extract prizes from Kansas Lottery: ' . $e->getMessage());
        }
