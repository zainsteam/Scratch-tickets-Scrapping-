...
class KentuckyLotteryScraper implements BaseScraper
{
    public function canHandle(string $url): bool
    {
        return str_contains($url, 'kylottery.com');
    }

    
    public function getSiteName(): string
    {
        return 'Kentucky Lottery';
    }
    ...
    public function extractBasicInfo(Crawler $crawler): array
    {
        ...
        try {
            ...
            Log::error('Failed to extract basic info from Kentucky Lottery: ' . $e->getMessage());
        }
    ...
    public function extractOdds(Crawler $crawler): array
    {
        ...
        try {
            ...
            Log::error('Failed to extract odds from Kentucky Lottery: ' . $e->getMessage());
        }
    ...
    public function extractImage(Crawler $crawler): ?string
    {
        try {
            ...
            Log::error('Failed to extract image from Kentucky Lottery: ' . $e->getMessage());
            return null;
        }
    }
    ...
    public function scrape(Crawler $crawler, string $url): array
    {
        try {
            ...
            Log::error('Kentucky Lottery scraping failed: ' . $e->getMessage(), ['url' => $url]);
            return ['error' => 'Failed to scrape Kentucky Lottery data', 'url' => $url];
        }
    }
    ...
    public function extractPrizes(Crawler $crawler): array
    {
        ...
        try {
            ...
            Log::error('Failed to extract prizes from Kentucky Lottery: ' . $e->getMessage());
        }
