...
class WestVirginiaLotteryScraper implements BaseScraper
{
    public function canHandle(string $url): bool
    {
        return str_contains($url, 'wvlottery.com');
    }
    ...
    public function extractBasicInfo(Crawler $crawler): array
    {
        ...
        try {
            ...
            Log::error('Failed to extract basic info from Virginia Lottery: ' . $e->getMessage());
        }
    ...
    public function extractOdds(Crawler $crawler): array
    {
        ...
        try {
            ...
            Log::error('Failed to extract odds from Virginia Lottery: ' . $e->getMessage());
        }
    ...
    public function extractImage(Crawler $crawler): ?string
    {
        try {
            ...
            Log::error('Failed to extract image from Virginia Lottery: ' . $e->getMessage());
            return null;
        }
    }
    ...
    public function scrape(Crawler $crawler, string $url): array
    {
        try {
            ...
            Log::error('West Virginia Lottery scraping failed: ' . $e->getMessage(), ['url' => $url]);
            return ['error' => 'Failed to scrape West Virginia Lottery data', 'url' => $url];
        }
    }
    ...
    public function extractPrizes(Crawler $crawler): array
    {
        ...
        try {
            ...
            Log::error('Failed to extract prizes from West Virginia Lottery: ' . $e->getMessage());
        }
