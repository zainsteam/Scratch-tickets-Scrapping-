...
class MississippiLotteryScraper implements BaseScraper
{
    ...
    {
        return str_contains($url, 'mslotteryhome.com');
    }
    ...
    public function extractBasicInfo(Crawler $crawler): array
    {
        ...
        try {
            ...
            Log::error('Failed to extract basic info from Mississippi Lottery: ' . $e->getMessage());
        }
    ...
    public function extractOdds(Crawler $crawler): array
    {
        ...
        try {
            ...
            Log::error('Failed to extract odds from Mississippi Lottery: ' . $e->getMessage());
        }
    ...
    public function extractImage(Crawler $crawler): ?string
    {
        try {
            ...
            Log::error('Failed to extract image from Mississippi Lottery: ' . $e->getMessage());
            return null;
        }
    }
    ...
    public function extractPrizes(Crawler $crawler): array
    {
        ...
        try {
            ...
            Log::error('Failed to extract prizes from Mississippi Lottery: ' . $e->getMessage());
        }
