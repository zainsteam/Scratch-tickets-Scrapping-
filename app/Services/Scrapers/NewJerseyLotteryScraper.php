...
class NewJerseyLotteryScraper implements BaseScraper
{
    ...
    public function extractBasicInfo(Crawler $crawler): array
    {
        ...
        try {
            ...
            Log::error('Failed to extract basic info from NewJersey Lottery: ' . $e->getMessage());
        }
    ...
    public function extractOdds(Crawler $crawler): array
    {
        ...
        try {
            ...
            Log::error('Failed to extract odds from NewJersey Lottery: ' . $e->getMessage());
        }
    ...
    public function extractImage(Crawler $crawler): ?string
    {
        try {
            ...
            Log::error('Failed to extract image from NewJersey Lottery: ' . $e->getMessage());
            return null;
        }
    }
